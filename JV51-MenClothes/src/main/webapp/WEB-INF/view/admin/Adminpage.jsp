                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fab fa-product-hunt"></i><span class="hide-menu">Product </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="listPro" class="sidebar-link"><i class="fas fa-list"></i><span class="hide-menu"> List </span></a></li>
                        </ul>
                    </li>
                                ...
                                <div class="box-ad-content">
                                    <div class="row">
                                        ...
                                        <div class="box-text">
                                            ...
                                            <b><a href="">${total} Khách hàng</a></b>
                                            <p class="box-info">Tổng khách hàng được quản lý</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-ad" style="float: left;margin-right: 17px">
                                <div class="box-ad-content">
                                    <div class="row">
                                        ...
                                        <div class="box-text">
                                            <h4>TỔNG SẢN PHẨM</h4>
                                            <b><a href="viewemp/1">${Totalpro} Sản phẩm</a></b>
                                            <p class="box-info">Tổng sản phẩm được quản lý</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-ad" style="float: right;margin-left: 17px;">
                                <div class="box-ad-content">
                                    <div class="row">
                                        ...
                                        <div class="box-text">
                                            <h4>TỔNG ĐƠN HÀNG</h4>
                                            <b><a href="getAll">${totalor} Đơn hàng</a></b>
                                            <p class="box-info">Tổng đơn hàng được quản lý</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-ad" style="float: left;margin-right: 17px">
                                <div class="box-ad-content">
                                    <div class="row">
                                        ...
                                        <div class="box-text">
                                            <h4>SẮP HẾT HÀNG</h4>
                                            <b><a href="getEmty">${totalEPro} sản phẩm</a></b>
                                            <p class="box-info">Số sản phẩm cảnh báo hết cần nhập thêm.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
